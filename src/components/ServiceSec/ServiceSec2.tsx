...
const ServiceSec2 = () => {
  return (
    <section>
        <div className="container flex flex-col-reverse lg:flex-row pb-20 gap-5">
            {/* description */}
            <div className="text-center md:text-start md:w-[500px] flex flex-col justify-center lg:pr-24 gap-5">
